...
class TalentAcquisitionScreen extends StatelessWidget {
  const TalentAcquisitionScreen({super.key});
            ...
            Column(
              children: [
                ...
                const Paragraph(
                  ...
                  Staffing Solutions: Whether you need temporary, contract, or permanent staff, we have a diverse pool of qualified candidates ready to meet your business demands.Recruitment Services: Our expert recruiters use cutting-edge technology and industry insights to identify and attract the best talent for your organization.Customized Talent Acquisition: We understand that every business is unique. Our tailored recruitment strategies ensure we find the perfect fit for your company culture and specific requirements.
                  """,
                ),
                SizedBox(height: screenHeight * 0.1),
                const Paragraph(
